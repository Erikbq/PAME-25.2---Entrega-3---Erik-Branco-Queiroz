...
import DescriptionAccordion from "@/components/home/DescriptionAccordion";
...
export default function Home() {
  return (
    <div className="h-full w-full flex flex-col gap-3">
      ...
      <div className="flex flex-col justify-center items-baseline w-full pl-2 gap-1.5">
      ...
      <div className="w-full h-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pb-3">
          <DayItemCard
          title="Item do Dia"
